    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <clipPath id="clip-path">
                <path d="M11.5 8L10 5L8.5 8L4.5 8.5L7.5 11L7 14.5L10 13L13 14.5V11.5L15 8.5L11.5 8Z"/>
            </clipPath>
        </defs>

        <path :d="`M5 16 L5 ${height} L15 ${height} L15 16`" fill="#F2C94C" clip-path="url(#clip-path)"/>
    ...
    export default {
        ...
        computed: {
            height() {
                let topCoord = 5,
                    bottomCoord = 15,
                    diff = bottomCoord - topCoord,
                    ratingPerCoord = diff / 5
                return bottomCoord - this.rating * ratingPerCoord
            }
        },
    }
</script>
